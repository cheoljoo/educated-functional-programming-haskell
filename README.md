...
6.1.1\.  [Monad](#monad)  
6.1.2\.  [pipeline](#pipeline)  
7\.  [Type Class](#typeclass-1)  
7.1\.  [Type Class](#typeclass-2)  
7.1.1\.  [Type Class](#typeclass-3)  
7.1.2\.  [사용자 정의 타입 클래스](#사용자정의타입클래스)  
7.2\.  [Functor , Applicative , Monad](#functorapplicativemonad)  
7.2.1\.  [Functor 타입 클래스](#functor타입클래스)  
7.2.2\.  [Applicative , Monad 타입 클래스](#applicativemonad타입클래스)  
...
<a name="typeclass-1"></a>

# 7\. Type Class

<a name="typeclass-2"></a>

## 7.1\. Type Class

<a name="typeclass-3"></a>
...
<a name="functorapplicativemonad"></a>

## 7.2\. Functor , Applicative , Monad

<a name="functor타입클래스"></a>

### 7.2.1\. Functor 타입 클래스
...
<a name="applicativemonad타입클래스"></a>

### 7.2.2\. Applicative , Monad 타입 클래스
- `<*>` 함수
